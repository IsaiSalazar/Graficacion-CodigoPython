...
class menu extends JFrame {
	...
	public void menus () {
		...
		JMenu archivo= new JMenu("Archivo"); //Menú archivo
		...
		JMenuItem sal= new JMenuItem("Salir",new ImageIcon("images/salir.gif")); //Menú Salir
		...
		JMenuItem abr= new JMenuItem("Abrir",new ImageIcon("images/libro_1.gif")); //Menú Abrir
		...
		JMenuItem guar= new JMenuItem("Guardar",new ImageIcon("images/guardar.gif")); //Menú guardar
		...
		JMenuItem cor= new JMenuItem("Cortar", new ImageIcon("images/cut.gif")); //Menú Editar 
		...
		JMenu about= new JMenu("Ayuda"); //Menú ayuda
		...
		JMenuItem acer= new JMenuItem("Acerca de...",new ImageIcon("images/chulo.gif"));  //Menú acerca de..
	...
	/** Creación de los botones del menú desplegable */
	public void barra () {
		JToolBar barras= new JToolBar(); //Contenedor para agregar los botones
		...
		barras.addSeparator(); //Agrega una separacion para dividir a los botones 
		...
		tFuente= new JComboBox(); // Permite agregar varias opciones 
		...
		tFuente.addItemListener(
			new ItemListener () {
				public void itemStateChanged(ItemEvent e) { //Llamado de la opción elegida 
		...
		getContentPane().add(barras,BorderLayout.NORTH); //Agrega el menu arriba del panel en el entorno
	}
	...
	public void abrir () {
		...
		if(name.exists()) {
			if (name.isFile()) {
				...
				catch (IOException ioException) { //Si hay un error al abrir el archivo 
