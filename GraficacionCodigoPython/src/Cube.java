	...
	TransformGroup objTrans = new TransformGroup();
	 ...
	 public  BranchGroup anima(){
		...
		public  BranchGroup letrasCubo(BranchGroup objRoot){
            ...
            Vector3d op = new Vector3d(.08,.1,.1);//Tamaño
            trans.setScale(op);    
		...
		//Metodo para añadir letras o palabras al mundo grafico pero con parametros de coordenadas de posicion
		...
		//Metodo para añadir letras o palabras al mundo grafico pero con parametros 
		//de coordenadas de posicion y aparte una bandera para establecer un color distinto y tamaño
